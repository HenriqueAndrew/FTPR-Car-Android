...
class LoginActivity : AppCompatActivity() {
    ...
    private fun setupView() {
        binding.loginComGogle.setOnClickListener {
            signIn()
        }
    ...
    private fun verifyCode() {
        val verificationCode = binding.verificarCodigo.text.toString()
    ...
    private fun sendVerificationCode() {
        val phoneNumber = binding.telefone.text.toString()
        val options = PhoneAuthOptions.newBuilder(auth)
            ...
            .setCallbacks(object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                ...
                override fun onCodeSent(verificationId: String, token: PhoneAuthProvider.ForceResendingToken) {
                    ...
                    Toast.makeText(
                        this@LoginActivity,
                        getString(R.string.codigo_verif_enviado),
                        Toast.LENGTH_SHORT
                    ).show()
                    binding.btnVerificarSms.visibility = View.VISIBLE
                    binding.verificarCodigo.visibility = View.VISIBLE
                }
    ...
    private fun setupGoogleLogin(){
        val gso = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
            .requestIdToken("652060319906-43f2np9ob0d318497s10p939ecqrmong.apps.googleusercontent.com")
            .requestEmail()
            .build()
